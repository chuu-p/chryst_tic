...
item types:
- seed/seedling (strainish, potentialish, plantable, breedable)
    - strainish
        - strain name
    ...
    - plantable
        ...
        - x
- harvested plant (strainish, potencyish, weighty, processable, dryable)
    - strainish
        - strain name
        - indica/sativa: -1 to 1
    - potencyish
...
- trim (extractable, recycleable, sellable)
    - recycleable
